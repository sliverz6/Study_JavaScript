class Course {
    ...
    constructor(courseTitle, coursePrice, courselLength) {
        this.title = courseTitle;
        this.price = coursePrice;
        this.length = courselLength;
    }
...
class PracticalCourse extends Course {
    constructor(title, length, price, exercisesCount) {
        ...
        this.numOfExercise = exercisesCount;
    }
}

const angularCourse = new PracticalCourse('Angular - The Complete Guide', 36, 50, 10);
